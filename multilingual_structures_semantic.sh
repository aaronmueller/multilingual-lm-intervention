...
MULTI_MODEL="facebook/xglm-564M"
...
#python neuron_experiment_multiple_templates_num_agreement.py $EN_MODEL semantic_short natural language:en && wait
#python neuron_experiment_multiple_templates_num_agreement.py $EN_MODEL semantic_short controlled language:en && wait
#python neuron_experiment_multiple_templates_num_agreement.py $EN_MODEL semantic_long natural language:en && wait
#python neuron_experiment_multiple_templates_num_agreement.py $EN_MODEL semantic_long controlled language:en && wait

python neuron_experiment_multiple_templates_num_agreement.py $MULTI_MODEL semantic_short natural language:en && wait
python neuron_experiment_multiple_templates_num_agreement.py $MULTI_MODEL semantic_short controlled language:en && wait
python neuron_experiment_multiple_templates_num_agreement.py $MULTI_MODEL semantic_long natural language:en && wait
python neuron_experiment_multiple_templates_num_agreement.py $MULTI_MODEL semantic_long controlled language:en && wait

python neuron_experiment_multiple_templates_num_agreement.py $MULTI_MODEL semantic_short natural language:en random_weights:true && wait
python neuron_experiment_multiple_templates_num_agreement.py $MULTI_MODEL semantic_short controlled language:en random_weights:true && wait
python neuron_experiment_multiple_templates_num_agreement.py $MULTI_MODEL semantic_long natural language:en random_weights:true && wait
python neuron_experiment_multiple_templates_num_agreement.py $MULTI_MODEL semantic_long controlled language:en random_weights:true && wait