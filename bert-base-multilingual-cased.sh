...
# python neuron_experiment_multiple_templates_num_agreement.py bert-base-multilingual-cased cuda . false rc_plural 3 200 && wait
# python neuron_experiment_multiple_templates_num_agreement.py bert-base-multilingual-cased cuda . false rc_plural 3 200 fr && wait
# python neuron_experiment_multiple_templates_num_agreement.py bert-base-multilingual-cased cuda . false rc_plural 3 200 nl && wait
